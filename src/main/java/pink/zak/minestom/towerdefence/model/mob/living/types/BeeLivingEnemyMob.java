...
public class BeeLivingEnemyMob extends LivingEnemyMob {
    ...
    public BeeLivingEnemyMob(TowerDefenceModule plugin, GameHandler gameHandler, EnemyMob enemyMob, Instance instance, TowerMap map, GameUser gameUser, int level) {
